...
class CustomContinuousMaPLeMTDA(CustomMaPLeMTDA):
    def __init__(self, cfg, classnames, clip_model):
        ...
        maple_cfg = cfg.TRAINER.MAPLE_MTDA
        self.prompt_learner = ContinuousMultiModalPromptLearner(
        ...
        print(f"ContinuousMaPLeMTDA pseudo-label weight: {self.lambda_pl}")
        print(f"ContinuousMaPLeMTDA pseudo-label threshold: {self.pl_threshold}")
        print(f"ContinuousMaPLeMTDA pseudo-label student threshold: {self.pl_student_threshold}")
        print(
            "ContinuousMaPLeMTDA pseudo-label low-conf only: "
            f"{self.pl_use_student_low_conf_mask}"
        )
        print(f"ContinuousMaPLeMTDA zero-shot prompt template: {zs_template}")
