...
def collect(root, seed):
    ...
    method_dirs = [child for child in sorted(root.iterdir()) if child.name.startswith("clip_")]
...
def main():
    ...
    csv_path = repo_root / "results" / f"officehome_clip_vpt_{suffix}.csv"
    md_path = repo_root / "results" / f"officehome_clip_vpt_{suffix}.md"
